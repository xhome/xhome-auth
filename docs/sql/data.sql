...
/* 认证管理配置项 */
INSERT INTO xhome_xauth_config VALUES(2, 1, 'xauth_next_page', '登录跳转地址', 'http://127.0.0.1:8081/xauth-test/dashboard.htm', 1, 1, NOW(), NOW(), 0, 2);
INSERT INTO xhome_xauth_config VALUES(3, 1, 'xauth_try_limit', '登录尝试次数', '3', 1, 1, NOW(), NOW(), 0, 2);
/* 密码错误锁定时间， 单位为秒 */
INSERT INTO xhome_xauth_config VALUES(4, 1, 'xauth_lock_time', '登录锁定时间', '180000', 1, 1, NOW(), NOW(), 0, 2);
/* 1 开启， 0 关闭 */
INSERT INTO xhome_xauth_config VALUES(5, 1, 'xauth_allow_auth_log', '认证日志', '1', 1, 1, NOW(), NOW(), 0, 2);
/* 1 开启， 0 关闭 */
INSERT INTO xhome_xauth_config VALUES(6, 1, 'xauth_allow_manage_log', '管理日志', '0', 1, 1, NOW(), NOW(), 0, 2);
