...
public class UserServiceTest extends AbstractTest {
	...
	public UserServiceTest() {
		...
		((UserServiceImpl) userService)
				.registerUserManageListener(new TestUserManageListener());
		((UserServiceImpl) userService)
				.registerUserRoleManageListener(new TestUserRoleManageListener());
		((UserServiceImpl) userService)
				.registerUserAuthListener(new TestUserAuthListener());
		((UserServiceImpl) userService).registerUserAuth("test",
				new TestUserAuth());
	}
