...
public class TestConfigManageListener implements ConfigManageListener {
	private Logger logger = LoggerFactory
			.getLogger(TestConfigManageListener.class);

	@Override
	public boolean beforeConfigManage(User oper, short action, Config config,
			Object... args) {
		logger.debug("TEST BEFORE CONFIG MANAGE LISTENER {} {} {}", oper
				.getName(), action, config != null ? config.getItem() : "NULL");
		return true;
	}
	...
	public void afterConfigManage(User oper, short action, short result,
		...
		logger.debug("TEST AFTER CONFIG MANAGE LISTENER {} {} {}", oper
				.getName(), action, config != null ? config.getItem() : "NULL");
	}
