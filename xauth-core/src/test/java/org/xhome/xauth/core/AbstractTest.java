...
public abstract class AbstractTest {
    ...
    protected void printAuthLog(AuthLog authLog) {
        ...
        logger.debug("Id:" + authLog.getId() + "\tUser:"
                        ...
                        + authLog.getMethod() + "\tAddress:"
                        + authLog.getAddress() + "\tAgent:"
                        + authLog.getAgent() + "\tNumber:"
                        + authLog.getNumber() + "\tStatus:"
                        + authLog.getStatus());
    }
    ...
    protected void printManageLog(ManageLog manageLog) {
        ...
        logger.debug("Id:" + manageLog.getId() + "\tAction:"
                        + manageLog.getAction() + "\tType:"
                        + manageLog.getType() + "\tObj:" + manageLog.getObj()
