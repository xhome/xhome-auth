...
public class ManageLog extends Base {
    ...
    public final static int   MANAGE_LOG_XFILEUPLOAD = 3;
    public final static int   MANAGE_LOG_XSMS        = 4;
    public final static int   MANAGE_LOG_XSTATISTICS = 5;
    ...
    public ManageLog(int category, String content, Short action, Short type,
                    Long obj, Long user) {
        this.setCategory(category);
